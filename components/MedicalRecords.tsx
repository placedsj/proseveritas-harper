    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {isAdding && (
        <div className="bg-white p-6 rounded-xl border border-blue-200 animate-fade-in shadow-lg text-left">
          <h3 className="text-lg font-bold text-slate-900 mb-4 border-b border-slate-100 pb-2 uppercase tracking-wider">New Evidence Record</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g. SJRH Admission Report"
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-300 rounded p-2 text-slate-900 focus:border-blue-500 focus:outline-none transition-all"
                placeholder="e.g. Horizon Health"
              />
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full bg-slate-50 border border-slate-300 rounded p-3 text-slate-900 focus:border-blue-500 focus:outline-none font-mono text-xs h-32 transition-all"
