          ...
          <div key={record.id} className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm transition-all hover:border-blue-200">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => toggleExpand(record.id)} className="text-blue-600 hover:text-blue-800 p-1" aria-label={expandedIds.has(record.id) ? "Collapse record" : "Expand record"}>
