      ...
      {isAdding && (
        <div className="bg-white p-6 rounded-xl border border-blue-200 animate-fade-in shadow-lg text-left">
          <div className="flex justify-between items-center mb-4 border-b border-slate-100 pb-2">
             ...
             <button onClick={() => setIsAdding(false)} aria-label="Close audit entry form" className="text-slate-400 hover:text-slate-900 focus-visible:ring-2 focus-visible:ring-blue-500 rounded p-1 transition-colors"><X className="w-5 h-5" /></button>
          </div>
