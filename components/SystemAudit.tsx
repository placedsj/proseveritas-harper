...
import { ShieldAlert, Fingerprint, Eye, Search, Clock, AlertTriangle, Plus, Trash2, Save } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-6">
          ...
          {isAdding && (
            <div className="p-4 bg-blue-50 rounded border border-blue-200 text-left space-y-3 mb-4">
              <input
                type="text"
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="w-1/2 p-2 rounded border border-blue-200 text-sm"
                />
                <select
                  value={newLog.status}
              ...
              <textarea
                ...
                className="w-full p-2 rounded border border-blue-200 text-sm h-20"
              />
              <button
                onClick={handleSave}
                className="w-full bg-blue-600 text-white py-2 rounded font-bold text-sm flex justify-center items-center gap-2"
              >
