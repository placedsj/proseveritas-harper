...
// ⚡ Bolt Performance Optimization: Added React.memo and replaced currentView with isActive boolean prop to prevent unnecessary re-renders of all nav items on view change
