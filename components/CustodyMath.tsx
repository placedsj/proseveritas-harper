...
const CustodyMath: React.FC = () => {
  ...
  const addBlock = () => {
    ...
    setBlocks([block, ...blocks].sort((a,b) => b.scheduledStart > a.scheduledStart ? 1 : b.scheduledStart < a.scheduledStart ? -1 : 0)); // Bolt: Optimized sort by direct string comparison
