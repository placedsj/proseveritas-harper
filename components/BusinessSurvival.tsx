...
const BusinessSurvival: React.FC = () => {
  ...
  // Combined .filter().reduce() into a single-pass reduce to eliminate intermediate array creation.
  // Wrapped in useMemo to prevent recalculation on every keystroke when typing in the new task form.
