...
const BusinessSurvival: React.FC = () => {
  ...
  // ⚡ Bolt Optimization: Single-pass reduce wrapped in useMemo
  // Prevents O(n) array recalculation on every keystroke in the controlled inputs
  // Eliminates intermediate array creation from chained .filter().reduce()
