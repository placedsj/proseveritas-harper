...
const BusinessSurvival: React.FC = () => {
  ...
  // ⚡ Bolt: Single-pass reduce with useMemo
  // Impact: Reduces O(2N) to O(N) by eliminating intermediate array allocation,
  // and prevents recalculation during unrelated re-renders (like typing in inputs).
