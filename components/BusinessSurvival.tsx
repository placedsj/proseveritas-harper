...
const BusinessSurvival: React.FC = () => {
  ...
  // ⚡ Bolt: Calculate total value in a single pass to avoid intermediate array allocation
  // Memoized to prevent O(n) recalculations on every keystroke in the new task inputs
