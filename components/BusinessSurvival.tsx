...
const BusinessSurvival: React.FC = () => {
  ...
  // ⚡ Bolt: Single-pass reduce prevents intermediate array creation and iteration overhead. Expected impact: Faster task list updates, especially for large datasets.
