...
const PatternHeatmap: React.FC<PatternHeatmapProps> = ({ logs }) => {
  ...
  // ⚡ Bolt: Direct ISO string comparison is ~20x faster than instantiating new Date() objects in the sort comparator, and perfectly equivalent for ISO date strings.
