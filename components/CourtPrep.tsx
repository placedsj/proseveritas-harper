    ...
    <div className="space-y-8 max-w-3xl mx-auto">
      ...
      <section className="bg-slate-800 p-6 rounded-lg border border-slate-700">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-bold text-white">Sentencing Script (Feb 3)</h2>
        </div>
        <div className="bg-slate-900 p-4 rounded text-slate-200 italic font-serif leading-relaxed space-y-4">
          ...
          <p>"Any custody time I serve before the pending custody hearing means I lose contact with my daughter and cannot demonstrate the stability that the family court needs to see. Restitution is possible if I remain employed and functional."</p>
      ...
      <section className="bg-slate-800 p-6 rounded-lg border border-slate-700">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-bold text-white">Custody Argument (Date TBD)</h2>
        </div>
