...
import { ProcessedEvidenceItem, ScottLogEntry, SystemAuditLogEntry, MedicalRecord } from '../types';
...
const Dashboard: React.FC<DashboardProps> = ({ onNavigate }) => {
  ...
  useEffect(() => {
    ...
    const systemAuditLogs: SystemAuditLogEntry[] = JSON.parse(localStorage.getItem('systemAuditLogs') || '[]');
    ...
    setStats({
      ...
      sjrhPages: medicalRecords.reduce((acc, curr) => acc + (curr.pageCount || 0), 0)
    });
