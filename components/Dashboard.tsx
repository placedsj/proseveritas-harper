...
import { Scale, ArrowRight, FileText, GraduationCap, Heart, Activity, Gavel, ShieldCheck, Map, Package } from 'lucide-react';
import { ProcessedEvidenceItem, ScottLogEntry, SystemAuditLog, MedicalRecord, ViewState } from '../types';
...
const Dashboard: React.FC<DashboardProps> = ({ onNavigate }) => {
  ...
  useEffect(() => {
    ...
    setStats({
      ...
      sjrhPages: medicalRecords.reduce((acc, r) => acc + (r.pageCount || 0), 0)
    });
