...
import { ScottLogEntry, SystemAuditLog, MedicalRecord } from '../types';
...
const Dashboard: React.FC<DashboardProps> = ({ onNavigate }) => {
  ...
  useEffect(() => {
    ...
    setStats({
      verifiedExhibits: scottLogs.filter(l => l.exhibitRef && l.exhibitRef.trim() !== '').length,
      daysDenied: scottLogs.filter(l => l.category === 'Denial of Parenting Time').length,
      auditTargets: auditLogs.length,
