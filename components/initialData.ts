import { ScottLogEntry, ProcessedEvidenceItem, MedicalRecord, SystemAuditLog, TimelineEvent, CourtEvent } from '../types';
...
export const INITIAL_EVIDENCE: ProcessedEvidenceItem[] = RAW_EVIDENCE.map(r => ({ ...r, wScore: (r.prio || 5) * 2, verified: false }));
